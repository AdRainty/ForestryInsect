...
from utils.general import (
    ...
    xyxy2xywh, plot_one_box, strip_optimizer, set_logging, increment_path, check_imshow, check_requirements)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            for c in det[:, -1].unique():
                ...
                s += f"{n} devided {names[int(c)]}{'s' * (n > 1)}, "  # add to string
                total[names[int(c)]] = n.item()
